...
### 2.2. Raw Log Verification in Splunk
This verifies that the Indexer receives data from the host Kali with the appropriate sourcetype.
<img width="1568" height="96" alt="5" src="https://github.com/user-attachments/assets/f76d4c5b-e977-4e2e-861f-82b2e50c86d4" />
...
This step demonstrates that the alert was successful in writing a record to the system.
<br>
